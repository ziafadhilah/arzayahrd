...
import 'package:arzayahrd/pages/employee/permission/add.dart';
import 'package:arzayahrd/pages/employee/permission/shimmer_effect.dart';
import 'package:arzayahrd/pages/employee/permission/tabmenu.dart';
...
//main contex---------------------------
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          //         child: AddPermissionPageEmployee()));
        },
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                child: Text(
                  "${Waktu(DateTime.parse(_permission['data'][index]['date_of_filing'].toString())).yMMMMEEEEd()}",
                  style: TextStyle(
                      color: baseColor,
                      fontFamily: "Roboto-medium",
                      letterSpacing: 0.5,
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                      color: Colors.black87, fontFamily: "Roboto-medium"),
  ...
  Future _countPending(var user_id) async {
    try {
      ...
      http.Response response = await http.get(Uri.parse(
          "$base_url/api/employees/$user_id/permission-submissions?status=pending"));
  ...
  void statusPermission() async {
    var result = await Navigator.push(
        context,
        PageTransition(
            type: PageTransitionType.rightToLeft,
            child: TabMenuPermissionPageEmployee()));
