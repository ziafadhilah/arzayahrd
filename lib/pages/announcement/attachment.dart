...
class DetailAttachmentPage extends StatefulWidget {
  var attachment, title;

  DetailAttachmentPage({this.attachment, this.title});

  @override
  State<DetailAttachmentPage> createState() => _DetailAttachmentPageState();
}

class _DetailAttachmentPageState extends State<DetailAttachmentPage> {
  String urlPDFPath = "";
  bool exists = true;
  int _totalPages = 0;
  int _currentPage = 0;
